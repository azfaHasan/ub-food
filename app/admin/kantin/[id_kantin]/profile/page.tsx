...
import { adminUpdateKantinProfile, type FormState } from "@/lib/actions/kantin.actions"; 
...
export default async function AdminEditKantinProfilePage({ params }: EditKantinPageProps) {
  ...
  const updateKantinWithId = adminUpdateKantinProfile.bind(
    null,
    kantin.id_kantin
  );
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6">
          <nav className="flex items-center gap-2 text-sm flex-wrap">
            ...
            <span className="text-slate-900 font-semibold">Moderasi Profile</span>
          </nav>
        </div>
        ...
        {/*Quick Actions Footer (link diubah ke admin) */}
