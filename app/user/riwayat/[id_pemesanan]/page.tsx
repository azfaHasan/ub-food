...
// import { StatusPemesanan, StatusPembayaran } from "@prisma/client";
...
//     where: {
//       id_pemesanan: paramsNew.id_pemesanan,
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6">
          <nav className="flex items-center gap-2 text-sm">
            <Link href="/user/riwayat" className="text-slate-600 hover:text-blue-600 transition-colors font-medium">
              Riwayat Pesanan
            </Link>
        ...
        <div className="mb-6 grid sm:grid-cols-2 gap-4">
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-slate-500 mb-1">Kantin</p>
                <p className="text-lg font-bold text-slate-900">{pemesanan.Kantin.nama_kantin}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden mb-6">
            <div className="px-8 py-6 border-b border-slate-200 bg-gradient-to-r from-slate-50 to-slate-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-xl font-bold text-slate-900">Catatan Pesanan</h2>
                </div>
              </div>
            </div>
            <div className="p-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Link
            href="/user/riwayat"
            className="flex-1 inline-flex items-center justify-center gap-2 px-6 py-3 bg-slate-100 text-slate-700 rounded-xl hover:bg-slate-200 transition-colors font-medium"
          >
          ...
          {pemesanan.status_pemesanan === 'SELESAI' && (
            <button className="flex-1 inline-flex items-center justify-center gap-2 px-6 py-3 bg-purple-600 text-white rounded-xl hover:bg-purple-700 transition-colors font-medium shadow-sm hover:shadow-md">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
